...
const environments: Environment[] = [
  {
    ...
    description: 'Espaço completo e equipado para atendimentos odontológicos',
    icon: '🦷',
    features: ['Cadeira odontológica', 'Iluminação profissional', 'Esterilização']
  },
  {
    id: 'terapia',
    ...
    icon: '🧘',
    features: ['Poltrona confortável', 'Ambiente calmo', 'Privacidade total']
  },
  {
    id: 'estetica',
    name: 'Sala de Estética',
    description: 'Equipada para procedimentos estéticos e cuidados com a pele',
    icon: '✨',
    features: ['Maca profissional', 'Iluminação adequada', 'Climatizado']
  },
  {
    id: 'psicologia',
    name: 'Consultório de Psicologia',
    description: 'Espaço tranquilo e confidencial para atendimentos psicológicos',
    icon: '💭',
    features: ['Ambiente reservado', 'Decoração neutra', 'Isolamento acústico']
  }
];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#636E72] mt-4 max-w-2xl mx-auto leading-relaxed">
            Reserve seu espaço em 4 passos simples e rápidos
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-12 overflow-x-auto">
          <div className="flex items-center justify-center min-w-max px-4">
            ...
            <div className="flex items-center">
              ...
              <span className={`ml-3 text-sm font-medium hidden sm:inline ${currentStep === 'time' ? 'text-[#2D3436]' : 'text-[#636E72]'}`}>Horário</span>
            </div>
          ...
          {currentStep === 'environment' && (
            <div className="bg-white p-10 rounded-2xl shadow-xl">
              <div className="text-center mb-10">
                ...
                <p className="text-[#636E72]">Selecione o espaço ideal para seu atendimento</p>
              </div>
